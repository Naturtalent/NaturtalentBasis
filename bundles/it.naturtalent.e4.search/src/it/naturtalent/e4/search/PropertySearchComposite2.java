...
public class PropertySearchComposite2 extends Composite
{
	 ...
	 * @param style
	 */
	public PropertySearchComposite2(Composite parent, int style)
	{
		super(parent, style);
		...
		GridData gd_textSearchMask = new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1);
		...
		GridData gd_groupModify = new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1);
		gd_groupModify.heightHint = 56;
		...
		groupDateGroup.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 1, 1));
