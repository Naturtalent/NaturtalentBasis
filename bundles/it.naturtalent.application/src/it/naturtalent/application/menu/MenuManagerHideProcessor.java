...
/**
 * <code>MenuManagerHideProcessor</code> provides hooks for renderer processing before and after the
 * <code>MenuManager</code> calls out to its <code>IMenuManagerListener2</code> for the <code>menuAboutToHide</code>
 * events.
 */
@SuppressWarnings("restriction")
public class MenuManagerHideProcessor implements IMenuListener2 {

	private static final String DYNAMIC_ELEMENT_STORAGE_KEY = "MenuManagerShowProcessor.dynamicElements";
	...
	/**
	 * Process dynamic menu contributions provided by {@link MDynamicMenuContribution} application model elements
	 *
	 * @param menu
	 * @param menuModel
	 *
