...
public class E4ModelElementOpener implements ECPModelElementOpener
{
	...
	public final static String EDITOR_PART_DESCRIPTOR = "org.eclipse.emf.ecp.e4.application.partdescriptor.editor"; //$NON-NLS-1$
	...
	public void openModelElement(Object modelElement, ECPProject ecpProject)
	{
		...
		{
			if (!EDITOR_PART_DESCRIPTOR.equals(existingPart.getElementId()))
			{
				continue;
			}
			...
			if (existingPart.getContext()
					.get(ECPE4Editor.INPUT) == modelElement)
			{
		...
		final MPart part = partService.createPart(EDITOR_PART_DESCRIPTOR);
