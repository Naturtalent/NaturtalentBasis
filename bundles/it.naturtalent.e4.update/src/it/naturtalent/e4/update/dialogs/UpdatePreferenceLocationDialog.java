...
public class UpdatePreferenceLocationDialog extends TitleAreaDialog
{
	...
	private String updateSiteLocation = null;
	 ...
	 * @param parentShell
	 */
	public UpdatePreferenceLocationDialog(Shell parentShell)
	{
		super(parentShell);
	}
	...
	{
		return new Point(660, 300);
	}

	@Override
	protected void okPressed()
	{		
		updateSiteLocation = comboLocation.getText();		
		super.okPressed();
	}
	...
	public void setInitialValues(String [] values)
	{
		...
		{
			comboLocation.setItems(values);
			comboLocation.setText(values[0]);
		}
	}
