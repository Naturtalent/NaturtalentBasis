...
public class CopyOfUpdatelHandler
{
			...
			IEclipsePreferences prefs)
	{
		...
		Job j = new Job("Update Job")
		{
			...
			protected IStatus run(final IProgressMonitor monitor)
			{
				...
				final IInstallableUnit[] allTeamCityFeatures = getExistingFeatures(monitor,agent);	
				operation = ProvisioningUI.getDefaultUI().getUpdateOperation(Arrays.asList(allTeamCityFeatures), new URI[] { repoLocationURI });
				
				
				//final IInstallableUnit[] allTeamCityFeatures = getExistingCategories(monitor,agent);
				//operation = new UpdateOperation(new ProvisioningSession(agent),Arrays.asList(allTeamCityFeatures));
				...
				//operation = new UpdateOperation(new ProvisioningSession(agent),iuSet);				
