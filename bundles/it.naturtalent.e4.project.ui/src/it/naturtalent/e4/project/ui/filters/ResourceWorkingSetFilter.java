...
/**
 * A resource working set filter filters resources from a view that are neither
 * a parent nor children of a working set element.
 * 
 * @since 2.0
 */
public class ResourceWorkingSetFilter extends ViewerFilter
{
	...
	/**
	 * Returns if the given resource is enclosed by a working set element. The
	 * IContainmentAdapter of each working set element is used for the
	 * containment test. If there is no IContainmentAdapter for a working set
	 * element, a simple resource based test is used.
	 * 
	 * @param element
	...
	/**
	 * Filters out elements that are neither a parent nor a child of a working
	 * set element.
	 * 
