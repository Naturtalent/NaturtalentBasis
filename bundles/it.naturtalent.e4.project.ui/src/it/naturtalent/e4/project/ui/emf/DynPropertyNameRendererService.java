 ...
 * 
 */
public class DynPropertyNameRendererService implements EMFFormsDIRendererService<VControl>
{
			...
			ViewModelContext viewModelContext)
	{
		...
		if (ProjectPackage.eINSTANCE.getDynPropertyItem_Name().equals(eStructuralFeature))
		{
			return 20.0;			
		}
	...
	{
		return DynPropertyNameRenderer.class;	
	}
