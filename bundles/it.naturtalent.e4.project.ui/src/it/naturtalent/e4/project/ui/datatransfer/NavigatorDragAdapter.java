...
public class NavigatorDragAdapter extends DragSourceAdapter {
    private static final String CHECK_MOVE_TITLE = DataTransferMessages.DragAdapter_title;

    private static final String CHECK_DELETE_MESSAGE = DataTransferMessages.DragAdapter_checkDeleteMessage;
