...
public interface IWorkingSetManager {
	...
	public final static String OTHER_WORKINGSET_NAME = "Andere";
	
	
	
	public final static String TAG_WINDOW_AGGREGATE = "Aggregate for window ";
	...
	/**
	 * Die Ressourcen aller verfügbaren WorkingSets in einem WorkingSet 
	 * zusammenfassen.  
	 * 
	 * @return
	 */
	...
	/**
	 * Aktualisiert das WorkingSet 'OtherProjects'   
	 * 
	 * @return
	 */
