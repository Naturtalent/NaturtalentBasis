...
public class WorkbenchAdapterFactory implements IAdapterFactory
{
	 ...
	 *         if this adapter provider does not have an adapter of the given
	...
	/**
	 * Returns the collection of adapter types handled by this provider.
	 * <p>
	...
	/**
	 * Returns an object which is an instance of IElementFactory associated with
	 * the given object. Returns <code>null</code> if no such object can be
	 * found.
	 */
	...
	/**
	 * Returns an object which is an instance of IPersistableElement associated
