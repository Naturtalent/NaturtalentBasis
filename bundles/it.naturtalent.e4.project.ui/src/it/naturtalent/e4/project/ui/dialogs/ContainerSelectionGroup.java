...
public class ContainerSelectionGroup extends Composite {
	...
	private static final String DEFAULT_MSG_NEW_ALLOWED = "neue Container erlaubt";

	private static final String DEFAULT_MSG_SELECT_ONLY = "nur selektierte Container erlaubt";
