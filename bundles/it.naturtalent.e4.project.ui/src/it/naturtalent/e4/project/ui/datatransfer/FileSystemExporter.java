...
public class FileSystemExporter
{
	 ...
	 * <code>destinationPath</code>. This creates a new file system directory.
	 * 
	 * @param destinationPath
	 *            location to which files will be written
	 */
	 ...
	 * 
	 * @param resource
	 *            the resource to write out to the file system
	 * @param destinationPath
	 *            location where the resource will be written
	 * @exception CoreException
	 *                if the operation fails
	 * @exception IOException
	 *                if an I/O error occurs when writing files
	 */
		...
		} finally
		{
			if (contentStream != null)
			{
				...
				} catch (IOException e)
				{
					...
					/*
					IDEWorkbenchPlugin
							.log("Error closing input stream for file: " + file.getLocation(), e); //$NON-NLS-1$
							*/
				}
			}
			if (output != null)
