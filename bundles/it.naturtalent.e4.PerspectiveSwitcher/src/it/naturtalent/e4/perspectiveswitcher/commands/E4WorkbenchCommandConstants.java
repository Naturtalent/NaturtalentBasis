 ...
 ******************************************************************************/ 
package it.naturtalent.e4.perspectiveswitcher.commands;
...
public interface E4WorkbenchCommandConstants {
	 ...
	 */
	public static final String CATEGORY_PERSPECTIVES$_DESCRIPTION = "Manipulation der workbench Perspectiven"; //$NON-NLS-1$
