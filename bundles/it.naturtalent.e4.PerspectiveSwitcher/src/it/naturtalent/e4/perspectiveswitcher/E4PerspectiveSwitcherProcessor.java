...
import it.naturtalent.e4.perspectiveswitcher.handlers.ClosePerspectiveHandler;
import it.naturtalent.e4.perspectiveswitcher.handlers.E4WorkbenchHandlerConstants;
import it.naturtalent.e4.perspectiveswitcher.handlers.ResetPerspectiveHandler;
import it.naturtalent.e4.perspectiveswitcher.handlers.SaveAsPerspectiveHandler;
import it.naturtalent.e4.perspectiveswitcher.handlers.ShowPerspectiveHandler;
import it.naturtalent.e4.perspectiveswitcher.handlers.ShowTextPerspectiveHandler;
...
public class E4PerspectiveSwitcherProcessor {
	...
	String contributorURI = PerspectiveActivator.getDefault().getPlatformURI();
	...
	void init() {
		...
		List<MCategory>l = application.getCategories();
		...
		{ // SaveAs command & handler definition
			...
			saveAsHandler.setContributionURI(PerspectiveActivator.getDefault().getResourceURI(SaveAsPerspectiveHandler.class));
		...
		{ // Reset command & handler definition
			...
			resetHandler.setContributionURI(PerspectiveActivator.getDefault().getResourceURI(ResetPerspectiveHandler.class));
		...
		{ // Close command & handler definition
			...
			closeHandler.setContributionURI(PerspectiveActivator.getDefault().getResourceURI(ClosePerspectiveHandler.class));
		...
		{ // ShowText command & handler definition
			...
			showTextHandler.setContributionURI(PerspectiveActivator.getDefault().getResourceURI(ShowTextPerspectiveHandler.class));
		...
		{ // Show Perspective command & handler with properties
			...
			showTextHandler.setContributionURI(PerspectiveActivator.getDefault().getResourceURI(ShowPerspectiveHandler.class));
			application.getHandlers().add(showTextHandler);
		}
	}
