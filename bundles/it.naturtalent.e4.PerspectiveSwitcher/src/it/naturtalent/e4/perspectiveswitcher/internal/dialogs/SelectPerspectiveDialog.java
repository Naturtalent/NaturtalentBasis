 ...
 ******************************************************************************/
package it.naturtalent.e4.perspectiveswitcher.internal.dialogs;
		...
		ISelectionChangedListener
{
	 ...
	 */
	@Inject
	public SelectPerspectiveDialog(@Named(IServiceConstants.ACTIVE_SHELL)
	Shell shell)
	{
		super(shell);
	...
	private void createViewer(Composite parent)
	{
		...
		viewer.setLabelProvider(new DelegatingLabelProviderWithTooltip(
				ContextInjectionFactory.make(PerspectiveLabelProvider.class,
						context), ContextInjectionFactory.make(
						PerspectiveLabelDecorator.class, context))
		{
		...
		viewer.setContentProvider(ContextInjectionFactory.make(
				PerspectiveContentProvider.class, context));
	...
	protected void okPressed()
	{
		...
		parameters.put(
				E4WorkbenchParameterConstants.COMMAND_PERSPECTIVE_NEW_WINDOW,
				"false");
